  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-gray-800 to-black">
      ...
      <main className="container mx-auto flex-grow px-4 sm:px-6 lg:px-8 animate-fadeIn">
        ...
        >
          <p>
            I've been extensively working on visualization with the{" "}
            <a
            ...
            , particularly using matplotlib.
          </p>
          <br />
          <p>
            I'm passionate about transforming raw data into comprehensible
            visualizations, and below are my favorite visualizations, both
            images and videos. <b>Click on each</b> for more details and the
            associated code.
          </p>
          <br />
        </motion.div>
