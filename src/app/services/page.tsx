...
const Services: React.FC = () => {
  ...
  const demos = [
    {
      title: "Data Analysis",
      description: "I can help you understand your data through in-depth analysis that communicate insights effectively. I can also create static or animated visualizations for more specific needs, such as a research paper or report.",
      examples: [
    ...
    },
    {
      ...
      description: "I can make statistical analysis, from simple hypothesis testing and linear models to more advanced use cases such as machine learning training and prediction tasks. I can also implement various generative AI tools such as chatbot (GPT, Claude...)",
      examples: [
    ...
    },
    {
      ...
      description: "I can build interactive web applications that bring your data to life, automate boring tasks, and much more!",
      examples: [
    ...
    },
    {
      ...
      description: "If you have a more specific need, don't hesitate to contact me and we'll see if I can help you solve your problem.",
      examples: [
      ...
      <main className="container mx-auto font-light flex-grow p-4 sm:p-6 md:p-8 animate-fadeIn">
        ...
        <section className="mb-6 sm:mb-8 p-4 sm:p-6 rounded-lg border border-gray-700 hover:border-gray-500 transition-colors duration-300">
          <p className="text-md sm:text-lg mb-4">
            I offer data science <b>services</b>. I can help you to <b>understand your data</b>, create beautiful <b>visualizations</b>, implement <b>statistical models</b>, develop <b>web applications</b> and more.
          </p>
          <p>
            If that's something you're interested in, feel free to contact me at:
          </p>
          <br/>
        ...
        <section className="mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl mb-8 sm:mb-10 text-center bg-clip-text">Expertise Showcase</h2>
              ...
              >
                ...
                >
                  ...
                  <div className={`overflow-hidden transition-all duration-300  "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}>
                    <h4 className="text-lg font-medium text-purple-400 mb-2">Examples:</h4>
        ...
        <section className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl mb-4 sm:mb-6 text-center">Past experiences</h2>
          ...
          {[
            {
              ...
              description: "I offer data science services: from data cleaning to data visualization, making predictive models and building web apps. Feel free to contact me if you're interested."
            },
            {
              title: "Data scientist and open source developer intern - Dataviz Universe",
              period: "March 2024 - Aug 2024",
              description: "Dataviz Universe brings together sites created by Yan Holtz around data visualisation. I was working with Yan Holtz on a variety of projects, all data-related: an R package on ecology modeling, the Python/R Graph gallery sites and open source Python libraries."
            },
            {
